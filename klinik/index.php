    ...
    <body>
        ...
        <script> 
            function printTable() {
                ...
                printWindow.document.write('<h2 style="text-align: center;">Nama:' + '<?php echo $_SESSION["nama"]; ?>' + '</h2>');

                printWindow.document.write('<h2 style="text-align: center;">IC:'+ '<?php echo $_SESSION["id"]; ?>' +'</h2>');
                printWindow.document.write('<h2 style="text-align: center;">Nombor Telefon:'+ '<?php echo $row["phone_number"]; ?>' +'</h2>');
